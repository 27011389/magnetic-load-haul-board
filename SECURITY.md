...
Do not commit credentials, `.env` files, the `data/` directory, SQLite backups,
screenshots containing unapproved personal information, or generated
...
approved access layer. Restrict access to the onsite host, application folder,
operational SQLite database and backups to authorised administrators.
